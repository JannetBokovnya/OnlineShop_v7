...
namespace OnlineShop.UserManagementService.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IdentityResult> GhangePassword(UserPasswordChangeRequest request)
        {
            var user = await _userManager.FindByNameAsync(request.UserName);
            if (user == null)
                return IdentityResult.Failed(new IdentityError() { Description = $"User {request.UserName} was not faund" });
